...
public class SingletonThreadPool {
    ...
    private SingletonThreadPool(){
        executorService = new ThreadPoolExecutor(corePoolSize,maxPoolSize,keepAliveTime,TimeUnit.MICROSECONDS,new LinkedBlockingQueue<Runnable>(blockingQueueSize));
    }
